 ...
 * returns number of elements deleted, or zero if no elements deleted
 *
 **/
Questions.prototype.deleteQuestion = function deleteQuestion(idx) {
    ...
    return (listOfQuestions.splice(idx, 1)).length;  // Remove the element at index
};
