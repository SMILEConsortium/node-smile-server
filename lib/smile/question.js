 ...
 * returns the mSessionID of the deleted question or 0 if none
    ...
    for (var userkey in this.currentQuestions) {
        if (this.currentQuestions.hasOwnProperty(userkey)) {
            ...
            for (var i = 0; i < userQs.length; i++) {
                if (userQs[i].mSessionID === qdata.mSessionID) {
                    console.log("Deleting question matching mSessionID = " + qdata.mSessionID);
