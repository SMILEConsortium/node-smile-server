...
Student.prototype.registerAnswer = function registerAnswers(answers) {
  this.status.solved = true;
  this.answers = answers;
}

Student.prototype.registerRating = function registerRating(rating) {
  this.rating = rating;
}
...
StudentsWrapper.prototype.registerAnswer = function registerAnswer(message) {
  if (!message.NAME) {
  ...
  student.registerAnswer(message.MYANSWER);
  student.registerRating(message.MYRATING);
}
