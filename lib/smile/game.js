...
Game.prototype.addQuestion = function addQuestion(message) {
	  if (message.NAME == 'teacher') {
		...
		if (((message.IP) && (this.students.hasStudent(message.IP))) || (message.IP && message.NAME)) {
		  ...
		  return js.JumboError.unexpected('The question provided refers to nonexistent student: ' + message.IP + ", name=" + mesage.NAME);
		}
	  }
}
