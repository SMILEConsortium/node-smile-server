...
var UnexpectedError = require('../js').UnexpectedError;
...
Game.prototype.addQuestion = function addQuestion(message) {
  if (this.students.hasStudent(message.IP)) {
    ...
    this.questions.addQuestion(message);
  } else {
    return new UnexpectedError('The question provided refers to inexistent student: ' + message.IP);
  }
}
