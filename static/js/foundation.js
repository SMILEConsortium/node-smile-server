...
window.Modernizr = function(e, t, n) {
    ...
    return f.addTest = function(e, t) {
        if (typeof e == "object")for (var r in e)k(e, r) && f.addTest(r, e[r]); else {
            e = e.toLowerCase();
            if (f[e] !== n)return f;
    ...
    k = function(e) {
        ...
        if (i(e))o(e, 0, h, 0); else if (S(e))for (f = 0; f < e.length; f++)c = e[f], i(c) ? o(c, 0, h, 0) : S(c) ? k(c) : Object(c) === c && a(c, h); else Object(e) === e && a(e, h)
...
(function(e, t) {
    ...
    s.extend({Deferred: function(e) {
        ...
        if (v.attachEvent)for (p in{submit: 1, change: 1, focusin: 1})h = "on" + p, d = h in v, d || (v.setAttribute(h, "return;"), d = typeof v[h] == "function"), t[p + "Bubbles"] = d;
    ...
    s.fn.extend({find: function(e) {
        ...
        if (s.isArray(e)) {
            ...
            while (o && o.ownerDocument && o !== t) {
                for (r = 0; r < e.length; r++)s(o).is(e[r]) && n.push({selector: e[r], elem: o, level: u});
                o = o.parentNode, u++
            }
            return n
        }
    ...
    $t = Ut.exec(Vt.toLowerCase()) || [], s.fn.extend({load: function(e, n, r) {
        ...
        if (!r.beforeSend || r.beforeSend.call(i, E, r) !== !1 && y !== 2) {
            for (w in{success: 1, error: 1, complete: 1})E[w](r[w]);
            v = Gt(Xt, r, n, E);
    ...
    var ln = {}, cn, hn, pn = /^(?:toggle|show|hide)$/, dn = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i, vn, mn = [
    ...
    "getBoundingClientRect"in n.documentElement ? Sn = function(e, t, n, r) {
        ...
        if (!r || !s.contains(n, e))return r ? {top: r.top, left: r.left} : {top: 0, left: 0};
...
(function(e) {
    ...
    e("form.custom span.custom.checkbox").on("click", function(t) {
        ...
        if (0 == i.is(":disabled"))return r.toggleClass("open"), r.hasClass("open") ? e(document).bind("click.customdropdown", function(t) {
